      ...
      <div className="md:flex md:flex-row md:items-center md:justify-between md:max-w-[1200px] md:mx-auto">
        ...
        <div className="w-full md:w-1/2 text-left px-6 py-10 md:py-0 md:px-12">
          ...
          <p className="opacity-50 mb-6 text-xl">
            Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker 
            uses high-end audiophile components that represents the top of the line 
            powered speakers for home or studio use.
          </p>
          <p className="font-bold text-2xl mb-6">$3,500</p>
